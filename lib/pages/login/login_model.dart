...
class LoginModel extends FlutterFlowModel<LoginWidget> {
  ...
  // State field(s) for Name_created widget.
  FocusNode? nameCreatedFocusNode;
  TextEditingController? nameCreatedTextController;
  String? Function(BuildContext, String?)? nameCreatedTextControllerValidator;
  ...
  void dispose() {
    ...
    nameCreatedFocusNode?.dispose();
    nameCreatedTextController?.dispose();
